    ...
    <div ref={formRef} className="relative z-20 order-2 lg:order-2">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          ...
          <div
            className="absolute inset-0 bg-gradient-to-br from-neutral-900/40 via-neutral-800/30 to-neutral-900/40"
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(\"data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='2' cy='2' r='1.5' fill='%23fff' fill-opacity='0.02'/%3E%3C/svg%3E\")",
              opacity: 0.3,
              zIndex: 1,
              pointerEvents: 'none',
            }}
        ...
        <div className="relative z-10 bg-neutral-900/30 backdrop-blur-2xl rounded-2xl border border-neutral-700/20 p-6 sm:p-8 shadow-xl">
          {/* Join Form */}
          <div
            ref={joinFormRef}
          ...
          >
            <div className="text-center mb-6 sm:mb-8">
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-2 transition-all duration-500 hover:scale-105">
                Join a Room
              </h2>
              <p className="text-sm sm:text-base text-neutral-400 transition-all duration-500 delay-100">
                Enter a room code to start listening together
              </p>
            </div>
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 bg-neutral-800/40 rounded-xl border border-neutral-600/50 transition-all duration-300 hover:bg-neutral-800/60 hover:border-neutral-500/70 group hover:scale-[1.02] hover:shadow-lg">
                <div className="text-xs sm:text-sm text-neutral-400 transition-all duration-300 group-hover:text-neutral-300 font-medium">
                  You'll join as
                </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="relative group">
                  ...
                  <div
                    className={`absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 transition-opacity duration-500 pointer-events-none ${formState.isFocused ? 'opacity-100' : 'group-hover:opacity-50'}`}
                  ></div>
                  {formState.error && (
                    <p className="text-red-400 text-sm mt-2 text-center animate-shake">
                      {formState.error}
                    </p>
                  )}
                </div>
              ...
              <Suspense fallback={null}>
                <RecentRoomsList
                  recentRooms={formState.recentRooms}
                  onJoinRecent={joinRecentRoom}
                />
              </Suspense>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-neutral-900/50 px-3 text-neutral-500 font-medium tracking-wider">
                    or
                  </span>
                </div>
              </div>
                  ...
                  {formState.isCreatingRoom ? (
                    ...
                    <>
                      <svg
                        ...
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        className="transition-transform duration-300 group-hover:scale-110 sm:w-5 sm:h-5"
                      >
          ...
          >
            ...
            <div className="w-full p-4 sm:p-6 rounded-xl border border-neutral-600/30 mb-6 shadow-inner">
              <div className="text-center">
                <div className="text-neutral-400 text-xs mb-2 font-medium uppercase tracking-wider">
                  Room Code
                </div>
                <div className="text-white font-mono text-xl sm:text-2xl font-bold tracking-wider mb-3 bg-gradient-to-r from-neutral-200 to-neutral-400 bg-clip-text text-transparent break-all">
                  {formState.createRoomSessionId}
                </div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                  <div className="flex flex-col items-center">
                    <Suspense fallback={null}>
                      <QRCodeDisplay
                        value={`${window.location.origin}/?session=${formState.createRoomSessionId}`}
                        size={100}
                      />
                    </Suspense>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <button
                      onClick={() =>
                        copyToClipboard(
                          `${window.location.origin}/?session=${formState.createRoomSessionId}`
                        )
                      }
