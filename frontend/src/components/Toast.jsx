...
function Toast({ message, onClose, mobile = false }) {
  ...
  const iconStyle =
    "w-4 h-4 text-neutral-400 group-hover:text-white transition";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg className={iconStyle} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2">
