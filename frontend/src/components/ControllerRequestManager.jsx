...
export default function ControllerRequestManager({
  ...
  const requestReceivedVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(showRequestReceived, 400, 'animate-slide-in-right');
  const requestStatusVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(requestStatus, 400, 'animate-fade-in-scale');
  const requestResultVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(requestResult, 400, 'animate-bounce-in');
  const controllerOfferVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(showControllerOffer, 400, 'animate-bounce-in');
  const offerSentVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(showOfferSent, 400, 'animate-slide-in-right');
  const offerAcceptedVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(showOfferAccepted, 400, 'animate-bounce-in');
  const offerDeclinedVisible = reducedMotion
    ? { isVisible: true, animationClass: '' }
    : useSmoothAppearance(showOfferDeclined, 400, 'animate-shake');

  return (
    <div
      className={`space-y-3 ${(isController && (showRequestReceived || pendingControllerRequests.length > 0)) || (!isController && (requestStatus || requestResult)) ? 'border-t border-neutral-800 pt-4' : ''}`}
    >
      {/* Request Result Notification */}
      {requestResult && (
        <div
          className={`rounded-lg p-3 ${requestResultVisible.animationClass} bg-neutral-900 border border-neutral-800`}
        >
      ...
      {!isController && showControllerOffer && controllerOfferReceived && (
        <div
          className={`bg-neutral-900 border border-neutral-800 rounded-lg p-3 ${controllerOfferVisible.animationClass} transform transition-all duration-500 hover:scale-[1.02] hover:shadow-lg`}
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h4 className="text-neutral-400 font-medium text-sm transition-all duration-300">
                Controller Offer
              </h4>
      ...
      {isController && showOfferSent && (
        <div
          className={`bg-neutral-900 border border-neutral-800 rounded-lg p-3 ${offerSentVisible.animationClass} transform transition-all duration-500 hover:scale-[1.02] hover:shadow-lg`}
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-neutral-800 rounded-lg flex items-center justify-center animate-pulse">
              <svg
      ...
      {isController && showOfferAccepted && (
        <div
          className={`bg-neutral-900 border border-neutral-800 rounded-lg p-3 ${offerAcceptedVisible.animationClass} transform transition-all duration-500 hover:scale-[1.02] hover:shadow-lg`}
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-neutral-800 rounded-lg flex items-center justify-center animate-pulse">
              <svg
      ...
      {isController && showOfferDeclined && (
        <div
          className={`bg-neutral-900 border border-neutral-800 rounded-lg p-3 ${offerDeclinedVisible.animationClass} transform transition-all duration-500 hover:scale-[1.02] hover:shadow-lg`}
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-neutral-800 rounded-lg flex items-center justify-center animate-pulse">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="text-neutral-400 animate-shake"
              >
                <circle cx="12" cy="12" r="10"></circle>
                <line x1="15" y1="9" x2="9" y2="15"></line>
                <line x1="9" y1="9" x2="15" y2="15"></line>
      ...
      {isController && showRequestReceived && (
        <div
          className={`bg-neutral-900 border border-neutral-800 rounded-lg p-3 ${requestReceivedVisible.animationClass} transform transition-all duration-500 hover:scale-[1.02] hover:shadow-lg`}
        >
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-neutral-800 rounded-lg flex items-center justify-center animate-pulse">
              <svg
      ...
      {!isController && requestStatus && (
        <div
          className={`rounded-lg p-3 ${requestStatusVisible.animationClass} bg-neutral-900 border border-neutral-800`}
        >
          <div className="flex items-center gap-3">
            <div
              className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 bg-neutral-800`}
            >
          ...
          <div className="space-y-2">
            {pendingControllerRequests.map((request, index) => (
              ...
              >
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <span className="text-white font-medium text-sm">{request.requesterName}</span>
                    <span className="text-neutral-500 text-xs">
                      {formatTimeAgo(request.requestTime)}
                    </span>
                  </div>
                  <p className="text-neutral-500 text-xs">Wants to become the controller</p>
                </div>
                <div className="flex items-center gap-2">
                  <button
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-neutral-800/80 rounded-lg flex items-center justify-center group-hover:bg-neutral-700/80 transition-all duration-300 group-hover:scale-110">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="text-neutral-400 group-hover:text-neutral-300 transition-all duration-300 group-hover:scale-110"
              >
                <path d="M12 2L2 7l10 5 10-5-10-5z"></path>
                <path d="M2 17l10 5 10-5"></path>
                <path d="M2 12l10 5 10-5"></path>
            ...
            <div>
              <p className="text-neutral-300 text-sm font-medium transition-all duration-300 group-hover:text-white">
                Controller Access
              </p>
              <p className="text-neutral-500 text-xs transition-all duration-300 group-hover:text-neutral-400">
                Request permission to control playback
              </p>
            </div>
          </div>
          <button
