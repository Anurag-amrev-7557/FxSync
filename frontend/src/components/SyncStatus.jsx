...
const SyncStatus = React.memo(function SyncStatus({
  status,
  showIcon = true,
  compact = false,
  ...
  return (
    <div className="flex flex-col gap-1">
      <div
        className={`inline-flex items-center gap-2 px-3 py-1 rounded-lg text-xs font-medium border transition-all duration-300 hover:scale-105 animate-fade-in-fast ${config.styles}`}
      >
        {showIcon && config.icon && <div className="flex-shrink-0">{config.icon}</div>}
