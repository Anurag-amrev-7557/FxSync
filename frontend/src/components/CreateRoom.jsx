        ...
        <div className="flex flex-col items-center justify-center p-8 rounded-lg border border-neutral-800 shadow-xl max-w-[28rem] mx-auto animate-scale-in">
          ...
          <div className="w-full p-4 rounded-lg border border-neutral-700 mb-6">
            <div className="text-center">
              ...
              <div className="mt-2 text-xs text-neutral-500 break-all flex flex-col items-center gap-1">
                <span>
                  Share:&nbsp;
                  <span className="underline decoration-dotted cursor-pointer hover:text-primary transition" onClick={handleCopyLink} title="Copy link">
                    {shareUrl}
                  </span>
                  {copied === 'link' && (
                    <span className="ml-2 text-green-400 text-xs animate-fade-in-fast">Link Copied!</span>
                  )}
                </span>
                <button
                  onClick={handleShare}
                ...
                >
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" className="text-white">
                    <path d="M4 12v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7" stroke="currentColor" strokeWidth="2"/>
                    <polyline points="16 6 12 2 8 6" stroke="currentColor" strokeWidth="2" fill="none"/>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-white">
              <path d="M12 19V6M5 12l7-7 7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Enter Room
          </button>
          <button
